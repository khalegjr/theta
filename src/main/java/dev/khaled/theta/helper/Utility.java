...
public class Utility {
    ...
    public static LocalDateTime retrieveDate(Map<String, Object> dataMap, String key, int hour, int minute,
            int second) {
        if (dataMap != null) {
            ...
            if (text != null) {
                ...
                text = fields[0] + "-" + (fields[1].length() == 1 ? "0" : "") + "-"
                        + (fields[2].length() == 1 ? "0" : "") + fields[2];
    ...
    public static LocalDateTime retrievDateEndDay(Map<String, Object> dataMap, String key) {
        return retrieveDate(dataMap, key, 23, 59, 59);
    }

    public static <T> T coalesce(T valeu, T defaultValue) {
        if (valeu == null) {
            return defaultValue;
        } else {
            return valeu;
